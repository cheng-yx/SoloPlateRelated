...
# ファイルダイアログの表示
    ...
    inpButton = ttk.Button(frame1, text="参照", command=inpdialog_clicked)
...
if __name__ == "__main__":
    ...
    a_df['calculated'] = a_df['Z'] - (a_df['analysis'] - a_df['sinWave']) #添加了新列calculated
    ...
    pdfname = 'C:\\Users\\cheng\\Desktop\\Docteral Doc\\paper4\\initial_imperfection\\050\\ID_ID_050ShellModel.pdf'
    pp = PdfPages(pdfname)
